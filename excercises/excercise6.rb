...
# remove duplicates without specifically removing any one value
...
array.uniq!
puts "Array with duplicates removed using the .uniq! method which mutates the caller unlike .uniq"
p array 
